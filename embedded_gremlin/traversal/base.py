...
class GraphTraversal(GraphTraversalBase, ABC):
    ...
    def V(self):
        ...
        from embedded_gremlin.traversal.constant import VTraversal
    ...
    def has(self, key: str, value: Any) -> "GraphTraversal":
        ...
        """
        from embedded_gremlin.traversal.filter import HasTraversal
    ...
    def as_(self, *names: str) -> "GraphTraversal":
        ...
        """
        from embedded_gremlin.traversal.format import AsTraversal
    ...
    def out(self, *edge_types: str) -> "GraphTraversal":
        ...
        """
        from embedded_gremlin.traversal.move import OutTraversal
    ...
    def in_(self, *edge_types: str) -> "GraphTraversal":
        ...
        """
        from embedded_gremlin.traversal.move import InTraversal
    ...
    def select(self, *args: str) -> "GraphTraversal":
        ...
        from embedded_gremlin.traversal.format import SelectTraversal
    ...
    def where(self, target: Union["GraphTraversal",
        ...
        * A filtering predicate to be applied to the paths that enter this step.
        ...
        """
        from embedded_gremlin.traversal.filter import \
            WhereSubqueryTraversal, WherePredicateTraversal
        from embedded_gremlin.predicate import VertexPredicate
    ...
    def repeat(self, loop_body: "GraphTraversal") -> "GraphTraversal":
        ...
        """
        from embedded_gremlin.traversal.recurse import RepeatTraversal
    ...
    def emit(self, emit_pred: "VertexPredicate" = None) -> "GraphTraversal":
        ...
        calls.
        """
        from embedded_gremlin.predicate import TruePredicate
    ...
    def constant(self, value: Any,
        ...
        """
        from embedded_gremlin.traversal.constant import ConstantTraversal
    ...
    def coalesce(self, *subqueries: "GraphTraversal") -> "GraphTraversal":
        ...
        the parent traversal.
        """
        from embedded_gremlin.traversal.recurse import CoalesceTraversal
    ...
    def union(self, *subqueries: "GraphTraversal") -> "GraphTraversal":
        ...
        :return: A GraphTraversal that adds the indicated `union` step to
         the parent traversal.
        """
        from embedded_gremlin.traversal.recurse import UnionTraversal
    ...
    def values(self, field_name: str) -> "GraphTraversal":
        ...
        the parent traversal.
        """
        from embedded_gremlin.traversal.format import ValuesTraversal
    ...
    def sum(self) -> "GraphTraversal":
        ...
        the parent traversal.
        """
        from embedded_gremlin.traversal.aggregate import SumTraversal
    ...
    def group(self) -> "GraphTraversal":
        ...
        the parent traversal.
        """
        from embedded_gremlin.traversal.aggregate import GroupTraversal
    ...
    def groupBy(self,
        ...
        * Alias to apply to the resulting path element
        ...
        the parent traversal.
        """
        from embedded_gremlin.traversal.aggregate import GroupByTraversal
